...
const TryAgain = ({ words, characters, wpm, startAgain }) => {
    return(
            ...
            <div>
                ...
                <button onClick={() =>{
                    window.open("https://www.facebook.com/share/sharer.php?u=theleanprogrammer.com/aam",
                ...
                <button onClick={() => {
                    window.open("https://www.twitter.com/intent/tweet?text=theleanprogrammer.com",
                                "twitter",
                                "width=800,height=600"
                                );
